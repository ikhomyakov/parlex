...
//!
//! This module defines the [`TermLexer`] type, which tokenizes term input and
//! yields [`TermToken`] values. The lexer is generated by the [`alex`] tool and
//! includes pattern actions that build numbers, atoms, strings, dates, and manage
//! nested parentheses and comments. It also integrates operator definitions
//! (`OperDefs`) to recognise operator names and yields special tokens with
//! operator table indices. See the crate documentation for details.
//!
